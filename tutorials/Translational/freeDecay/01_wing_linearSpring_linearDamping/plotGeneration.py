...
actualFolder=os.getcwd();print("actualFolder= ",actualFolder)

freeDecayCase=True

translationalSpring=True
print("freeDecayCase= ",freeDecayCase,"translationalSpring= ",translationalSpring)
...
print("freeDecayCase= ",freeDecayCase)
if not freeDecayCase:
